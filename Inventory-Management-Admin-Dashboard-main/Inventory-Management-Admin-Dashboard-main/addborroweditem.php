...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert data into the borrowed records table
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        header("Location: borrowedlist.php");
        exit();
    } else {
...
<h4>Drag and drop a file to upload</h4s>
</div>
</div>
</div>
</div>
...
<a href="borrowedlist.php" class="btn btn-cancel">Cancel</a>
</div>
</div>
</div>
</div>
