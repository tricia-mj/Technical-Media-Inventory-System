...
$sql = "SELECT borrower, date, time, venue, item_borrowed, department, course_program, signature 
        FROM borrowed_items"; // Replace 'borrowed_items' with your actual table name
...
<div class="page-btn">
<a href="addborroweditem.php" class="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img" class="me-1">Add New Item</a>
</div>
</div>
